...
// Définit les éléments de navigation de l'en-tête
const navigation = [
...
// Fonction utilitaire pour gérer les classes de style conditionnelles
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-red-700 text-white' : 'text-red-600 hover:bg-gray-700 hover:text-white',
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-theme1-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
